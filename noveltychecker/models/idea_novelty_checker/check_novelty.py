...
from noveltychecker.models.idea_novelty_checker.prompts import (
...
async def get_review(idea, most_relevant_papers, incontext_example_path=None):
    ...
    if os.getenv("NOVELTY_CHECK_EXAMPLES") == "less-relaxed":
        incontext_example = open(
            "noveltychecker/models/idea_novelty_checker/incontext_examples/less-relaxed.json",
            "r",
        )

    elif os.getenv("NOVELTY_CHECK_EXAMPLES") == "relaxed":
        incontext_example = open(
            "noveltychecker/models/idea_novelty_checker/incontext_examples/relaxed.json",
            "r",
        )
    else:
